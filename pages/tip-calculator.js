		...
		<div className='w-full'>
			<div className='w-screen h-[30vh] lg:h-[40vh] relative'>
				...
				<div className='px-6 absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
					<h2 className='py-4'>Tip Calculator</h2>
			...
			<div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-16 px-6'>
				<div className='col-span-4 '>
					...
					<p className='py-6  first-letter:font-semibold'>
						Strona, która służy do obliczania wysokości napiwku w zależności od
						wpisanej kwoty i ilości osób. Kalkulator wyświetla gotową kwotę
						napiwku, a także pełną należność wraz z napiwkiem podzieloną na
						wpisaną ilość osób. Użytkownik może wybrać procent napiwku od
						wpisanej kwoty, lub samemu wpisać wybrany przez siebie procent. Do
						wykonania całego skryptu posłużył język Java Script, a do stylizacji
						preprocesor SASS. Użytkownicy powinni być w stanie zobaczyć
						optymalny układ strony w zależności od rozmiaru ekranu ich
						urządzenia, a także zobaczyć zmienny stan po najechaniu kursorem na
						interaktywne elementy strony. Pomysł na stronę został zaczerpnięty z
						serwisu{" "}
						<a
